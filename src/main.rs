...
/// Virheenkorjaustiedoissa näytettävä ohjelman nimi
const NAME: &str = "OispaHallaAnticheat";

/// Virheenkorjaustiedoissa näytettävä palvelimen nimi
#[cfg(feature = "server")]
const NAME_SERVER: &str = "HAC";

/// Virheenkorjaustiedoissa näytettävä ohjelman versio
const VERSION: &str = env!("CARGO_PKG_VERSION");

/// Tulostaa ohjeet ohjelman suorittamiseen
fn give_help() {
...
fn main() {
    ...
    let help = args.contains(&"--help".to_owned()) || !(enable_server || benchmark || game || analyze || do_hack);
